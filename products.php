                ...
                <div class="col-md-4 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p style="padding-top:20px;">Price: 2499.99 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-danger btn-block">Buy now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-4 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p style="padding-top:20px;">Price:1099.99 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-danger btn-block">Buy now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-4 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p style="padding-top:20px;">Price: 4999.99</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-danger btn-block">Buy now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-4 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, quibusdam perspiciatis error praesentium dolores exercitationem.</p>
                            <p style="padding-top:20px;">Price: 1699.99</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-danger btn-block">Buy now</a></p>
                                <?php
                            } else {
